                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-white/70 font-mono text-xs">#{company.company_id}</span>
                        </div>
                      ...
                      <div className="flex shrink-0 gap-2">
                        <Button
                          ...
                          className="border-blue-500/30 text-blue-400 hover:bg-blue-500/20 w-8 h-8 p-0"
                          title="Visualizar"
                        >
                        ...
                        <Button
                          ...
                          className="border-green-500/30 text-green-400 hover:bg-green-500/20 w-8 h-8 p-0"
                          title="Editar"
                        >
                    ...
                    <div className="mt-3 grid grid-cols-1 gap-1 text-sm">
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <span className="text-gray-200 break-words text-right">
                          {company.company_city} / {company.company_uf}
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="w-full table-fixed">
                      <thead className="bg-white/10">
                        ...
                        >
                          ...
                          <th className="hidden xl:table-cell text-left py-2 px-2 w-40">
                        <Button
                          variant="ghost"
                        ...
                        >
                          ...
                          <th className="hidden lg:table-cell text-left py-2 px-2 w-32">
                        <Button
                          variant="ghost"
                        ...
                        >
                          ...
                          <th className="hidden lg:table-cell text-left py-2 px-2 w-16">
                        <Button
                          variant="ghost"
                      ...
                      <tbody>
                        {companies.map((company) => (
                          ...
                          >
                            <td className="py-1 px-2 text-white font-mono text-sm">
                              {company.company_id}
                            </td>
                            <td className="py-1 px-2 text-white text-sm truncate" title={company.company_name}>
                              {company.company_name}
                            </td>
                            <td className="hidden xl:table-cell py-1 px-2 text-gray-300 text-sm truncate" title={company.company_fantasy}>
                              {company.company_fantasy || "-"}
                            </td>
                            <td className="py-1 px-2 text-gray-300 font-mono text-sm truncate" title={formatCpfCnpj(company.company_cpf_cnpj)}>
                              {formatCpfCnpj(company.company_cpf_cnpj)}
                            </td>
                            <td className="hidden lg:table-cell py-1 px-2 text-gray-300 text-sm truncate" title={company.company_city}>
                              {company.company_city}
                            </td>
                            <td className="hidden lg:table-cell py-1 px-2 text-gray-300 uppercase text-sm">
                              {company.company_uf}
                            </td>
